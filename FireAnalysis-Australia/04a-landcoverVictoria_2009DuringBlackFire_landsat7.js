...
//Filtering against Melbourne region during the Black Fires.
var landsat_SR = ee.ImageCollection("LANDSAT/LE07/C01/T1_SR") //load LANDSAT7 raws for during the fire period
	...
	//.filterDate("2009-02-08", "2009-02-09") //worst days of the fire, no result
	//No cloud filters; expecting clouds from the smoke anyway
...
Export.image.toDrive({
  image: single,
  description: "landsat_duringFire2009l7_Victoria_BigSquare",
