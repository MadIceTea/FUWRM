...
//Filtering against Melbourne region for the reaminder of the year after the Black Fires.
var landsat_SR = ee.ImageCollection("LANDSAT/LE07/C01/T1_SR") //load LANDSAT7 raws
	.filterBounds(Melbourne)
	.filterDate("2009-02-15","2010-01-01")
...
Export.image.toDrive({
  image: single,
  description: "landsat_preFire2008l7_Victoria_BigSquare",
