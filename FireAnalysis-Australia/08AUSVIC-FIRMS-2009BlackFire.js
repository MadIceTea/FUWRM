...
Map.addLayer(Labertouche, {color: "FFB7F5"}, "Labertouche, VIC, Australia", 1, 1); //pinkish-purple
Map.addLayer(DrouinWest, {color: "270BFF"}, "Drouin West, VIC, Australia", 1, 1); //royal-deep blue
