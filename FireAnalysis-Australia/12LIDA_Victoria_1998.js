...
//filtering Against the entire export region for one year timeframe (1998).
var landsat_SR = ee.ImageCollection("LANDSAT/LT05/C01/T1_SR") //load LANDSAT7 raws for during the fire period
...
Export.image.toDrive({
  image: single,
  description: "classifiedImage_1998_lowCloudVictoria_BigSquare",
