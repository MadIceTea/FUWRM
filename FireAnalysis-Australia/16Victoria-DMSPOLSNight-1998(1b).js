...
Map.addLayer(DMSP,{bands:["avg_vis", "stable_lights", "cf_cvg"],min:0,max:64.5}, "median nightmap", 0, 1);
var single = DMSP.select("stable_lights");
Map.addLayer(single,{bands:["stable_lights"],min:0,max:64.5,palette: ["black", "orange", "white"]},"average cleaned nightmap", 1, 1);
