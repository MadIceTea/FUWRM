...
var collection_a = ee.ImageCollection("JAXA/GPM_L3/GSMaP/v6/reanalysis")
  ...
  .filterDate("2009-02-16", "2009-06-01");
...
var single = intermediate.multiply(7632); //7632 hours in TOI (time period of interest)

var band_viz = {
  min: 0, //0mm in a year (@ 0mm/hr)
  max: 1145, //1.15m total in TOI @ 0.15mm/hr
...
Export.image.toDrive({
  image: single,
  description: "PrecipColored_postFire2009_Victoria_BigSquare",
