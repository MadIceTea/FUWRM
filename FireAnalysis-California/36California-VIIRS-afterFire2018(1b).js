...
//Import images for 2018, for the month of December (after the fire).
var collection = ee.ImageCollection("NOAA/VIIRS/DNB/MONTHLY_V1/VCMCFG")
  .filterDate("2018-12-01","2019-01-01") // for Dec. 2018
...
Export.image.toDrive({
  image: single,
  description: "VIIRS_2018_afterFireParadise_BigSquare-1b",
